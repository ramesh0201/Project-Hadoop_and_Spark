...
public class Join implements Serializable {
	...
	public static void spatialjoin(JavaSparkContext context, String inputfile1, String inputfile2, String inputfile3, String outputfile1, String outputfile2) {
		...
		JavaRDD<String> file1 = context.textFile(inputfile2);
		...
		JavaRDD<String> file2 = context.textFile(inputfile1);
	...
	public static void main( String[] args ) {
    	SparkConf conf = new SparkConf().setAppName("Group18-Join");
    	JavaSparkContext sc = new JavaSparkContext(conf);
    	spatialjoin(sc, args[0], args[1], args[2], args[3], args[4]);
    }
}
